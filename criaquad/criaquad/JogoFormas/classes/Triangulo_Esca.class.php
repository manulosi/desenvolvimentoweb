...
class Triangulo_Esca extends Triangulo
{
    ...
    public static function listar($tipo = 0, $busca = ""): array
    {
        ...
        while ($forma = $comando->fetch(PDO::FETCH_ASSOC)) {
            ...
            if($forma['formato'] == 3)
            $triangulo = new Triangulo_Esca($forma['idTriangulo'], $forma['lado1'], $forma['lado2'], $forma['lado3'], $forma['cor'], $forma['imagem'], $unidade, $forma['formato']);
            ...
            <a href='index.php?idTriangulo=" . $this->getId() . "'>
                <div style='position: relative; display: inline-block;'>
                    <div style='
                        ...
                        border-bottom: " . $this->getLado3() . $this->getUnidade()->getNome() . " solid transparent;
                        position: relative;
                    '>
                        <div style='
                            position: absolute;
