...
class Triangulo_Iso extends Triangulo
{

    public function  __construct($id = 0, $lado1 = 1, $lado2 = 1, $lado3 = 1,  $cor = "null", $imagem = "null", Unidade $unidade = null)
    {
        parent::__construct($id, $cor, $lado1, $lado2, $lado3, $imagem, $unidade);
    ...
    public static function listar($tipo = 0, $busca = ""): array
    {
        ...
        while ($forma = $comando->fetch(PDO::FETCH_ASSOC)) {
            ...
            if($forma['formato'] == 2)
            $triangulo = new Triangulo_Iso($forma['idTriangulo'], $forma['lado1'], $forma['lado2'], $forma['lado3'], $forma['cor'], $forma['imagem'], $unidade, $forma['formato']);
    ...
    public function desenhar()
{
    ...
    //                 height: " . max($this->getLado1(), $this->getLado2()) . $this->getUnidade()->getNome() . ";
